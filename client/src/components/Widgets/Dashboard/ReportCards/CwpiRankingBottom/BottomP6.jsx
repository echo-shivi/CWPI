...
const Bottom6 = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}dashboard/reportCard/reportDetails/cwpiRankingBottom/bottom6/details`);
    ...
    return (
        <div className="container bg-white rounded-lg mx-auto p-4 mb-5" ref={pdfRef}>
            ...
            <h1 className=" border-gray-300 text-center font-normal bg-gray-100 p-4 rounded-lg  text-gray-700 text-[22px] "> Bottom P6</h1>
