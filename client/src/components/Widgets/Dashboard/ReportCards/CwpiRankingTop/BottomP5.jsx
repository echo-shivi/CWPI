...
const Bottom5 = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}dashboard/reportCard/reportDetails/cwpiRankingTop/bottom5/details`);
    ...
    return (
        ...
        <h1 className=" border-gray-300 text-center font-normal bg-gray-100 p-4 rounded-lg  text-gray-700 text-[22px]"> Top P5</h1>
