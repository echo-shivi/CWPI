...
const Admins = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}dashboard/workAgency/agencyDetails/admin/details`);
                            ...
                            currentEntries.map((entry, index) => (
                                ...
                                >
                                    ...
                                    <td className="border font-medium">
                                        <button className='bg-blue-400  text-white transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 rounded-lg p-3 my-2'>View Details</button>
                                    </td>
                                </tr>
                            ))
                        ) : (
