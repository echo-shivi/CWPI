...
const EmployeeDetails = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:8001/api/dashboard/workAgency/agencyDetails/employeeDetails/details');
    ...
    return (
        <div className="container mx-auto p-4" ref={pdfRef}>
            <h1 className="items-center justify-start text-gray-700 font-medium text-2xl pb-6">Employee Details</h1>
