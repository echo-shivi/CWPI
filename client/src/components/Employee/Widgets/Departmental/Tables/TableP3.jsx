        ...
        const fetchData = async () => {
            try {
              const response = await axios.get(
                "http://localhost:8001/api/employee/deptP3/details"
              );
              setTablesData(response.data.deptP3);
            } catch (error) {
                        ...
                        <table className="table-auto w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th className="border h-16 text-base text-center bg-blue-400 text-white"> Date of Completion</th>
                                ...
                                {currentEntries.length > 0 ? (
                                    currentEntries.map((entry, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="border font-medium">{entry?.dateofcompletion}</td>
