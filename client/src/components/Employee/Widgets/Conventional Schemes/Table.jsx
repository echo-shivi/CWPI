                        ...
                        <table className="table-auto w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th className="border h-16 text-base text-center bg-blue-400 text-white"> Tendered Amount(in Rs. Lakhs) </th>
                                    <th className="border h-16 text-base text-center bg-blue-400 text-white">Cummulative Mb Booked Till Date(in Rs. lakhs</th>
                                ...
                                {currentEntries.length > 0 ? (
                                    currentEntries.map((entry, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="border font-medium">{entry?.action}</td>
                                            <td className="border font-medium">{entry?.adminApprovalAmount}</td>
                                        </tr>
                                    ))
                                ) : (
