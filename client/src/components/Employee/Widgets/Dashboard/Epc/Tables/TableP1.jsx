...
const TableP1 = () => {
        ...
        const fetchData = async () => {
            try {
              const response = await axios.get(
                "http://localhost:8001/api/employee/epcP1/details"
              );
              setTablesData(response.data.epcP1);
            } catch (error) {
        ...
        return searchTerm
            ? tablesData.filter(
                (entry) =>
                    ...
                    entry.masterscheme.toLowerCase().includes(searchTerm.toLowerCase())
            )
            : tablesData;
    ...
    return (
        <div className="container mx-auto p-2" ref={pdfRef}>
                        ...
                        <table className="table-auto w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th className="border h-16 text-base text-center bg-blue-400 text-white">Date of Approval</th>
                                    <th className="border h-16 text-base text-center bg-blue-400 text-white">Date of 1st Notice Inviting Tender Publication</th>
                                ...
                                {currentEntries.length > 0 ? (
                                    currentEntries.map((entry, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="border font-medium">{entry?.dateofapproval}</td>
                                            <td className="border font-medium">{entry?.dateof1stnoticeinvitingtenderpublication}</td>
                                    ...
                                    <tr className="h-10 text-base text-center">
                                        <td className="border font-medium" colSpan="7">No data Available in the table</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
