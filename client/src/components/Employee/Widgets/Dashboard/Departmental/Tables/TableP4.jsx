...
const TableP4 = () => {
        ...
        const fetchData = async () => {
            try {
              const response = await axios.get(
                "http://localhost:8001/api/employee/deptP4/details"
              );
              setTablesData(response.data.deptP4);
            } catch (error) {
    ...
    return (
        <div className="container mx-auto p-4 ml-8" ref={pdfRef}>
                        ...
                        <table className="table-auto w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th className="border h-16 text-base text-center bg-blue-400 text-white">Date of Completion As Per Work Order </th>
                                ...
                                {currentEntries.length > 0 ? (
                                    currentEntries.map((entry, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="border font-medium">{entry?.dateofcompletionasperworkorder}</td>
                                            <td className="border font-medium">{entry?.actualdateofcompletion}</td>
