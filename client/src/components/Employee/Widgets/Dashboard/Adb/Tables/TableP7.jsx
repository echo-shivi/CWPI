        ...
        const fetchData = async () => {
            try {
              const response = await axios.get(
                "http://localhost:8001/api/employee/deptP1/details"
              );
              setTablesData(response.data.deptP1);
            } catch (error) {
                                ...
                                {currentEntries.length > 0 ? (
                                    currentEntries.map((entry, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="border font-medium">{entry?.dateofadministrativeapproval}</td>
