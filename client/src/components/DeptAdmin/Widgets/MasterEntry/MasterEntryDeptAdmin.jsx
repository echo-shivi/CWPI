...
const MasterEntryDeptAdmin = () => {
  ...
  return (
    <div className=" bg-slate-100 rounded-lg container mx-auto p-4 mt-10" ref={pdfRef}>
      <div className="justify-between flex py-6">
        <h1 className="items-center justify-start font-medium text-2xl">
          Master Entry
        </h1>
        <button
          onClick={downloadPDF}
          className="btn-blue p-4 flex text-white font-medium rounded"
        >
              ...
              currentEntries.map((entry, index) => (
                ...
                >
                  ...
                  <td className="border font-medium">
                    <Link
                      to="/schemes"
                      className="bg-blue-400 text-white transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 rounded-lg p-3 my-2"
                    >
                      View Details
                    </Link>
                  </td>
...
export default MasterEntryDeptAdmin;
