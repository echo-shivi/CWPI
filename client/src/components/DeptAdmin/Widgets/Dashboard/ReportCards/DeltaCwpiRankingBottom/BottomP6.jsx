...
const Bottom6 = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}dashboard/reportCard/reportDetails/deltaCwpiRankingBottom/bottom6/details`);
                setTablesData(response.data.bottom6);
                console.log('API response:', response.data.bottom6);
            } catch (error) {
