...
const Bottom1 = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}dashboard/reportCard/reportDetails/deltaCwpiRankingBottom/bottom1/details`);
                setTablesData(response.data.bottom1);
                console.log('API response:', response.data.bottom1);
            } catch (error) {
