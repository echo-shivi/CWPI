...
const Bottom2 = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}dashboard/reportCard/reportDetails/deltaCwpiRankingBottom/bottom2/details`);
                setTablesData(response.data.bottom2);
                console.log('API response:', response.data.bottom2);
            } catch (error) {
    ...
    return (
        ...
        <h1 className=" border-gray-300 text-center font-normal bg-gray-100 p-4 rounded-lg  text-gray-700 text-[22px]"> Bottom P1</h1>
