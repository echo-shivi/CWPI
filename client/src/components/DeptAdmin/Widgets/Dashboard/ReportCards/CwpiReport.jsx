...
const CwpiReport = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}dashboard/reportCard/reportDetails/cwpiReport/details`);
                ...
                <table className="table-auto w-full">
                    <thead>
                        <tr>
                            ...
                            <th className="border h-16 text-base text-center bg-blue-400 text-white">CWPI Score</th>
                            <th className="border h-16 text-base text-center bg-blue-400 text-white">Percentile(Normalised)</th>
